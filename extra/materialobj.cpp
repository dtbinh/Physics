...
void MaterialObj::setMaterial(MaterialObj *mat, Vec4 ambient, Vec4 diffuse, Vec4 specular, float shininess)
{
    ...
    mat->ambient[2] = ambient.z();
    mat->ambient[3] = 1.0;

    mat->specular[0] = diffuse.x();
    mat->specular[1] = diffuse.y();
    mat->specular[2] = diffuse.z();
    mat->specular[3] = 1.0;

    mat->diffuse[0] = specular.x();
    mat->diffuse[1] = specular.y();
    mat->diffuse[2] = specular.z();
    mat->diffuse[3] = 1.0;
