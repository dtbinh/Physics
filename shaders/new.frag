#version 400 
    ...
    uniform mat4 shadowMapMatrix0; // Shadow map view-projection transforms for each of the two light sources 
    uniform mat4 shadowMapMatrix1; uniform sampler2D shadowMapTexture0;  // In case you were wondering: no, it is not possible to have an array of samplers. 
